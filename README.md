...
Hegic Protocol v888. Coming to Ethereum blockchain in October 2020: v1.1 → v888

[Hegic](https://www.hegic.co) is an on-chain peer-to-pool options trading protocol built on [Ethereum](https://github.com/ethereum).
